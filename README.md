...
2. Clone the repo
   ```sh
   git clone https://github.com/asktechsupport/help.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin asktechsupport/help
...
See the [open issues](https://github.com/asktechsupport/help/issues) for a full list of proposed features (and known issues).
