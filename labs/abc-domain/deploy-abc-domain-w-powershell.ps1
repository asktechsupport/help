#Create the 'abc' Domain with powershell
...
Rename-NetAdapter -Name “Ethernet0" -NewName “abc" #Rename the network adapter
New-NetIPAddress $NewIPAddress -InterfaceAlias "abc" -PrefixLength 24 #Set IP address
Set-DnsClientServerAddress -InterfaceAlias "abc" -ServerAddresses 127.0.0.1 #Set DNS 
...
Install-ADDSForest -DomainName abc.local
