...
# Get all servers in the domain with "ctrx" in their hostname
$servers = Get-ADComputer -Filter {OperatingSystem -Like "*Server*" -and Name -Like "*ctrx*"} | Select-Object -ExpandProperty Name
