...
[System.Windows.Forms.SendKeys]::SendWait('^f') # Open the search bar (Ctrl + F)
Start-Sleep -Seconds 1 # Wait for the search bar to open
[System.Windows.Forms.SendKeys]::SendWait('PNPT-DC') # Type the VM name
