...
<script language="C#" runat=server>
    ...
    // Localizable Text
    //
    const string L_DomainUserNameLabel_Text = "Email address:";
    ...
    const string L_DomainNameMissingLabel_Text = "You must enter a valid email address.";
...
<rdwastr:strings xmlns:rdwastr="urn:microsoft.com:rdwastrings">
  ...
  <string id="HeadingRDWA">Remote Desktop Services</string>
  <string id="HeadingApplicationName">Welcome to your apps</string>
  ...
  <string id="PrivacyLink">Privacy</string>
</rdwastr:strings>
